...
{
    public class CalculadoraPrestamos : ICalculadoraPrestamos
    {
        public ResultadoPrestamo CalcularPrestamo(SolicitudPrestamo solicitud)
        {
            // Convertir tasa anual a tasa mensual en formato decimal
            decimal tasaMensual = Math.Round(solicitud.TasaInteres / 100 / 12, 8);
